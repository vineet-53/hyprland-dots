...
--
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd ~/Documents/Obsidian-Notes<cr>")
...
vim.keymap.set("n", "<leader>os", ':Telescope find_files search_dirs={"~/Documents/Obsidian-Notes"}<cr>')
vim.keymap.set("n", "<leader>oz", ':Telescope live_grep search_dirs={"~/Documents/Obsidian-Notes"}<cr>')
--
